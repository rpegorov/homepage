...
![The Sync section of settings: syncing with the Drafta cloud, the Sync Now button, fields for your own CouchDB, and the Synced status](/blog-assets/en/sinhronizaciya-i-shifrovanie/sync-settings.png)
...
![The Drafta account creation screen: email, password, and confirmation fields, an explanation of the 30-day trial and a separate library password](/blog-assets/en/sinhronizaciya-i-shifrovanie/create-account.png)
