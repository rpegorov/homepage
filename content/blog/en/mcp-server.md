...
![The MCP section of the settings: the drafta-mcp server, the Read-only toggle, the library path field, and the Copy JSON config and Copy claude mcp add command buttons](/blog-assets/en/mcp-server/mcp-settings.png)
