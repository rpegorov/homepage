...
![Quick switch panel over the window: search field, list of notes with notebooks and tags, prefix hints at the bottom](/blog-assets/en/drafta-s-klaviatury/quick-open.png)
...
![Keybindings section: commands Bold, Italic, Strikethrough, Highlight, and others with shortcuts and Record buttons](/blog-assets/en/drafta-s-klaviatury/keybindings.png)
...
![Snippets section: list of snippets /img, /link, /table, /code, /date, /time, /datetime, /today with their bodies](/blog-assets/en/drafta-s-klaviatury/snippets.png)
...
![Text Substitutions section: six toggles — dash, period on double space, bracket autoclose, expression evaluation, typographic quotes, tag autocomplete](/blog-assets/en/drafta-s-klaviatury/text-substitutions.png)
