...
![A note with Completed status in split mode: a release checklist with checked items](/blog-assets/en/zametki-eto-faily/note-status.png)
...
![A note with the Bookmarks and Graph panels open: the graph links the note to tags and another note](/blog-assets/en/zametki-eto-faily/bookmarks-graph.png)
