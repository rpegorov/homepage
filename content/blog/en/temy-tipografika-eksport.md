...
![Appearance section: a list of eleven built-in themes with color swatches, Fjord selected](/blog-assets/en/temy-tipografika-eksport/builtin-themes.png)
...
![Drafta window in the Fjord theme: blue-gray tones, a note with a table and a checklist in editor mode](/blog-assets/en/temy-tipografika-eksport/fjord-theme.png)

*Fjord theme: cool blue-gray tones across all three columns of the window.*

![Drafta window in a light theme: warm paper background, note list with tags](/blog-assets/en/temy-tipografika-eksport/light-theme.png)
...
![Appearance section with three custom themes in the Custom Themes block and buttons for edit, copy, export, and delete](/blog-assets/en/temy-tipografika-eksport/custom-themes.png)
...
![Typography section: four built-in presets Default, Reading, Compact, Mono and a preview of headings and text](/blog-assets/en/temy-tipografika-eksport/typography-presets.png)
...
![Note menu: Unpin, Set Status, Revision History, Save as Template, Export…, Export as Markdown, HTML, PDF, Bundle, Copy as Markdown, Move to Trash](/blog-assets/en/temy-tipografika-eksport/export-menu.png)
...
![Export section of settings: three built-in profiles Clean, Developer, and Academic with color swatches, Clean selected](/blog-assets/en/temy-tipografika-eksport/export-profiles.png)
