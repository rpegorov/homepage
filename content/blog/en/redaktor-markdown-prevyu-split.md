...
![The source Markdown of a note in editor mode: line numbers, a highlighted heading, a mermaid block, a numbered list, and a checklist](/blog-assets/en/redaktor-markdown-prevyu-split/editor-source.png)
...
![Split mode: on the left, the Markdown of a note with a list of ideas; on the right, the same note rendered](/blog-assets/en/redaktor-markdown-prevyu-split/split-view.png)
...
![Preview of a note: a Mermaid diagram of five blocks, a numbered list, a quote, and a checklist](/blog-assets/en/redaktor-markdown-prevyu-split/preview-mermaid.png)
...
![Preview of a note with HTTP and JSON code blocks with line numbers and an endpoints table](/blog-assets/en/redaktor-markdown-prevyu-split/preview-code-table.png)
...
![A Markdown cheat sheet note with the table of contents panel on the right](/blog-assets/en/redaktor-markdown-prevyu-split/table-of-contents.png)
...
![Statistics popover: 148 words, 823 characters, 13 paragraphs, 1 minute of reading, tags, and dates](/blog-assets/en/redaktor-markdown-prevyu-split/note-statistics.png)
...
![Editor settings: display toggles, spell checking, autosave, and Vim mode](/blog-assets/en/redaktor-markdown-prevyu-split/editor-settings.png)
