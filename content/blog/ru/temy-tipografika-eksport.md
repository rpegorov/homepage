...
![Раздел Appearance: список из одиннадцати встроенных тем с цветовыми образцами, выбрана Fjord](/blog-assets/ru/temy-tipografika-eksport/builtin-themes.png)
...
![Окно Drafta в теме Fjord: сине-серые тона, заметка с таблицей и чек-листом в режиме редактора](/blog-assets/ru/temy-tipografika-eksport/fjord-theme.png)

*Тема Fjord: холодные сине-серые тона во всех трёх колонках окна.*

![Окно Drafta в светлой теме: тёплый бумажный фон, список заметок с тегами](/blog-assets/ru/temy-tipografika-eksport/light-theme.png)
...
![Раздел Appearance с тремя своими темами в блоке Custom Themes и кнопками правки, копирования, экспорта и удаления](/blog-assets/ru/temy-tipografika-eksport/custom-themes.png)
...
![Раздел Typography: четыре встроенных пресета Default, Reading, Compact, Mono и превью заголовков и текста](/blog-assets/ru/temy-tipografika-eksport/typography-presets.png)
...
![Меню заметки: Unpin, Set Status, Revision History, Save as Template, Export…, Export as Markdown, HTML, PDF, Bundle, Copy as Markdown, Move to Trash](/blog-assets/ru/temy-tipografika-eksport/export-menu.png)
...
![Раздел Export настроек: три встроенных профиля Clean, Developer и Academic с цветовыми образцами, выбран Clean](/blog-assets/ru/temy-tipografika-eksport/export-profiles.png)
