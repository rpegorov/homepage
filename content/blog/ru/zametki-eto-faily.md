...
![Заметка со статусом Completed в режиме split: чек-лист релиза с отмеченными пунктами](/blog-assets/ru/zametki-eto-faily/note-status.png)
...
![Заметка с открытыми панелями Bookmarks и Graph: граф связывает заметку с тегами и другой заметкой](/blog-assets/ru/zametki-eto-faily/bookmarks-graph.png)
