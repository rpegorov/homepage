...
![Панель быстрого перехода поверх окна: строка поиска, список заметок с блокнотами и тегами, внизу подсказки префиксов](/blog-assets/ru/drafta-s-klaviatury/quick-open.png)
...
![Раздел Keybindings: команды Bold, Italic, Strikethrough, Highlight и другие с сочетаниями и кнопками Record](/blog-assets/ru/drafta-s-klaviatury/keybindings.png)
...
![Раздел Snippets: список сниппетов /img, /link, /table, /code, /date, /time, /datetime, /today с их телами](/blog-assets/ru/drafta-s-klaviatury/snippets.png)
...
![Раздел Text Substitutions: шесть переключателей — тире, точка по двойному пробелу, автозакрытие скобок, вычисление выражений, типографские кавычки, автодополнение тегов](/blog-assets/ru/drafta-s-klaviatury/text-substitutions.png)
