...
![Окно Revision History: слева ревизия от 24 сентября с пометкой +11, справа unified diff заметки Ideas с добавленными строками](/blog-assets/ru/istoriya-reviziy-i-bekapy/revision-history.png)
...
![Раздел General настроек: поведение при запуске, режим просмотра по умолчанию, лимит недавних заметок, 30 ревизий на заметку и автоочистка корзины](/blog-assets/ru/istoriya-reviziy-i-bekapy/general-settings.png)
...
![Раздел Storage: автоматическая копия раз в неделю, хранить 7 копий, последняя 9 часов назад, следующая через 6 дней](/blog-assets/ru/istoriya-reviziy-i-bekapy/auto-backup.png)
