...
![Раздел Sync настроек: синхронизация с облаком Drafta, кнопка Sync Now, поля для собственного CouchDB и статус Synced](/blog-assets/ru/sinhronizaciya-i-shifrovanie/sync-settings.png)
...
![Экран создания аккаунта Drafta: поля почты, пароля и подтверждения, пояснение о 30-дневном триале и отдельном пароле библиотеки](/blog-assets/ru/sinhronizaciya-i-shifrovanie/create-account.png)
