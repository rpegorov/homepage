...
![Исходный Markdown заметки в режиме редактора: номера строк, подсвеченный заголовок, блок mermaid, нумерованный список и чек-лист](./redaktor-markdown-prevyu-split/editor-source.png)
...
![Режим split: слева Markdown заметки со списком идей, справа та же заметка отрендеренной](./redaktor-markdown-prevyu-split/split-view.png)
...
![Превью заметки: диаграмма Mermaid из пяти блоков, нумерованный список, цитата и чек-лист](./redaktor-markdown-prevyu-split/preview-mermaid.png)
...
![Превью заметки с HTTP- и JSON-блоками кода с номерами строк и таблицей эндпоинтов](./redaktor-markdown-prevyu-split/preview-code-table.png)
...
![Заметка-шпаргалка по Markdown с панелью оглавления справа](./redaktor-markdown-prevyu-split/table-of-contents.png)
...
![Поповер статистики: 148 слов, 823 символа, 13 абзацев, 1 минута чтения, теги и даты](./redaktor-markdown-prevyu-split/note-statistics.png)
...
![Настройки редактора: переключатели отображения, проверка орфографии, автосохранение и режим Vim](./redaktor-markdown-prevyu-split/editor-settings.png)
